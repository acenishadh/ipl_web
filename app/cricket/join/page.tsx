  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -right-40 top-0 h-[450px] w-[450px] rounded-full bg-pink-500/[0.06] blur-[100px]" />
        <div className="absolute -left-40 bottom-0 h-[400px] w-[400px] rounded-full bg-orange-500/[0.05] blur-[100px]" />
      </div>

      <div className="relative mx-auto max-w-md px-4 py-12 sm:px-6">
        <Link href="/cricket" className="mb-8 inline-flex items-center gap-2 text-sm text-white/40 transition-colors hover:text-white/70">
          ← Back
        </Link>

        <div className="mb-8">
          <h1 className="font-display text-4xl font-bold text-white">Join Cricket Room</h1>
          <p className="mt-2 text-sm text-white/50">Enter the room code your friend shared.</p>
        </div>
